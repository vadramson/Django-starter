...
urlpatterns = [
                  ...
                  path('base-api/csv_files_handler/', views.CSVManipulation.as_view(), name='csv_files_handler'),
                  ...
                  path('base-api/get_regions/', views.GetRegions.as_view(), name='get_regions'),
                  ...
                  path('base-api/get_agence/', views.GetAgence.as_view(), name='get_agence'),
